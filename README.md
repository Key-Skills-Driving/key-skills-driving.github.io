...
- **Saved:** only the breakdowns you choose to save (tap **Save** under one), plus prewritten ones you add. Tap any of them to copy it, or **Modify** to tell the AI what to change: it gets your original notes and the current version, and you can save or undo the result.
